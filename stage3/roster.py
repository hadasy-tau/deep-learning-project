...
Facts that shape this file (measured 6 Sep 2026, see stage3/plan.md):
  ...
  * ODATA pages at 100 rows; every response is cached under stage3/cache/odata so
...
from pipeline import normalize_he                      # Stage 1 normalisation, verbatim
