...
the pipeline itself behaved.
    ...
    python src/inference/verify.py outputs/A_whisper-large-v3.jsonl outputs/B_whisper-large-v3-turbo-ct2.jsonl

Scoring is Stage 1's, verbatim: normalize_he() from src/common.py, then
